...
# usage sbatch conservation.sh

# Define job name
#SBATCH -J conservation
...
echo python3 01_fungiDB_uniprot_seq_comparison_230824.py
python3 01_fungiDB_uniprot_seq_comparison_230824.py
