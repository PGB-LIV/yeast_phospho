...
[02_conservation_analysis/scripts](https://github.com/EllenBoswell/yeast_phospho/tree/main/02_conservation_analysis/scripts) - conservation of syntenic orthologs using inputs from FungiDB (i.e. includes check to only use proteins where the sequence in UniProt is the same as FungiDB) and multiple sequence alignment using MUSCLE.
